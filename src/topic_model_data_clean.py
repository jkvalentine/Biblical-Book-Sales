...
output = tarfile.open('/home/ubuntu/data/clean_english_texts.tar.gz', mode='w:gz')

#Open tar.gz archive of Gutenberg Texts
with tarfile.open('/home/ubuntu/data/gutenberg_texts.tar.gz', mode='r:gz') as f:
        ...
        for entry in f:
            ...
            if text == None:
                ...
                if text_string.find("Language: English") != -1:
